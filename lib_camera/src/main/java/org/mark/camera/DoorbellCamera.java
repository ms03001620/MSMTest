...
public class DoorbellCamera {
    ...
    private void preview() {
        try {
            ...
            if (mConfig.getMediaRecorder() != null) {
                mConfig.getMediaRecorder().setUpMediaRecorder();
            }
            ...
            Surface previewSurface = mConfig.getSurface();
            surfaces.add(previewSurface);
            builder.addTarget(previewSurface);

            if (mConfig.getMediaRecorder() != null) {
                Surface recorderSurface = mConfig.getMediaRecorder().getSurface();
                    ...
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            try {
                              ...
                              if (mConfig.getMediaRecorder() != null) {
                                    mConfig.getMediaRecorder().mMediaRecorder.start();
                                }
